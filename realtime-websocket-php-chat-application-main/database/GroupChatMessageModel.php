...
class GroupChatMessageModel
{
	...
	{
		$query =
			"INSERT INTO group_chat_messages (userid, group_chat_message, created_on) VALUES (:userid, :group_chat_message, :created_on)"
		;
	...
	{
		$query =
			"SELECT * FROM group_chat_messages INNER JOIN chat_application_users 
