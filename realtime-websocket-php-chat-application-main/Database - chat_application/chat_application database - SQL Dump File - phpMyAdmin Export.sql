...
CREATE TABLE `chat_application_users` (
  ...
  `user_verification_code` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Registration Verification Code sent to the user''s email',
  `user_login_status` enum('Logout','Login') NOT NULL,
  `user_token` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'A random unique string we generate with every login to be used in conjunction with `user_connection_id` to implement One-to-One Private Chat',
